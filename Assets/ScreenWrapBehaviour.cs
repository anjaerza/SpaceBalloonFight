...
public class ScreenWrapBehaviour : MonoBehaviour
{
    ...
    void CreateGhostShips()
    {
        for (int i = 0; i < 2; i++)
        {
            ...
            // But without the screen wrapping component and other stuff
            ...
            DestroyImmediate(ghosts[i].GetComponent<InstantDamage>());
            DestroyImmediate(ghosts[i].GetComponent<CapsuleCollider>());
            ...
            //GhostMovement ghostMovement = ghosts[i].gameObject.GetComponent<GhostMovement>();
